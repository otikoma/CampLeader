...
ons.ready(function() {
    ...
    var v1_0_1 = getStrageData('v1.0.1');
    //v1.0.1初回起動
    if(v1_0_1!=1) {
        var defaultGenres = [
            ...
            {"genreid":"g011","name":"衛生用品", "img":"images/camp-icons/healthcare.png","cls":"cls-cyan"},
            {"genreid":"g013","name":"釣具", "img":"images/camp-icons/fish.png","cls":"cls-blue"},
            {"genreid":"g015","name":"アクティビティー", "img":"images/camp-icons/transport.png","cls":"cls-lime"},
            {"genreid":"g014","name":"その他", "img":"images/camp-icons/oval.png","cls":"cls-grey"}
        ];
        saveStrageData('GearGenre', defaultGenres);
        saveStrageData('v1.0.1',1);
    }
});
function clearDebug() {
    removeStrageData('v1.0.1');
    removeStrageData('GearGenre');
}